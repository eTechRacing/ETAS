...
# c:/program files (x86)/etas/intecrio4.7/build/common/tools/pi_core-4.6/templates/instances_usercode.tpl
# DO NOT EDIT!
...
output(file, "    self->#{node.node_table[:coder]}Wrapper_#{node.node_table[:cname]}_Ptr = initInstance_#{node.node_table[:type]}Wrapper((uint32)&#{node.node_table[:var]}, sizeof(#{node.node_table[:cdt]}), (uint32)#{node.node_table[:width]}, (uint32)#{node.node_table[:kind]});")
elsif(node.node_table[:typeid]==3)
output(file, "    self->#{node.node_table[:coder]}Wrapper_#{node.node_table[:cname]}_Ptr = initInstance_#{node.node_table[:type]}Wrapper((uint32)&#{node.node_table[:var]}, sizeof(#{node.node_table[:cdt]}), (uint32)#{node.node_table[:width_x]}, (uint32)#{node.node_table[:width_y]}, (uint32)#{node.node_table[:kind]});")
elsif(node.node_table[:typeid]==4)
output(file, "    self->#{node.node_table[:coder]}Wrapper_#{node.node_table[:cname]}_Ptr = initInstance_#{node.node_table[:type]}Wrapper((uint32)&#{node.node_table[:var_ref1]}, sizeof(#{node.node_table[:cdt_ref1]}), (uint32)&#{node.node_table[:var]}, sizeof(#{node.node_table[:cdt]}), (uint32)#{node.node_table[:width]}, (uint32)INTERPOLATE_LINEAR, (uint32)EXTRAPOLATE_CONST, (uint32)#{node.node_table[:kind]});")
elsif(node.node_table[:typeid]==5)
output(file, "    self->#{node.node_table[:coder]}Wrapper_#{node.node_table[:cname]}_Ptr = initInstance_#{node.node_table[:type]}Wrapper((uint32)&#{node.node_table[:var_ref1]}, sizeof(#{node.node_table[:cdt_ref1]}), (uint32)&#{node.node_table[:var_ref2]}, sizeof(#{node.node_table[:cdt_ref2]}), (uint32)&#{node.node_table[:var]}, sizeof(#{node.node_table[:cdt]}), (uint32)#{node.node_table[:width_ref1]}, (uint32)#{node.node_table[:width_ref2]}, (uint32)INTERPOLATE_LINEAR, (uint32)EXTRAPOLATE_CONST, (uint32)#{node.node_table[:kind]});")
elsif(node.node_table[:typeid]==6)
output(file, "    self->#{node.node_table[:coder]}Wrapper_#{node.node_table[:cname]}_Ptr = initInstance_#{node.node_table[:type]}Wrapper(&self->#{node.node_table[:coder]}Wrapper_#{node.node_table[:cname_ref1]}_Ptr, (uint32)&#{node.node_table[:var]}, sizeof(#{node.node_table[:cdt]}), (uint32)#{node.node_table[:width]}, (uint32)INTERPOLATE_LINEAR, (uint32)EXTRAPOLATE_CONST, (uint32)#{node.node_table[:kind]});")
elsif(node.node_table[:typeid]==7)
output(file, "    self->#{node.node_table[:coder]}Wrapper_#{node.node_table[:cname]}_Ptr = initInstance_#{node.node_table[:type]}Wrapper(&self->#{node.node_table[:coder]}Wrapper_#{node.node_table[:cname_ref1]}_Ptr, &self->#{node.node_table[:coder]}Wrapper_#{node.node_table[:cname_ref2]}_Ptr, (uint32)&#{node.node_table[:var]}, sizeof(#{node.node_table[:cdt]}), (uint32)#{node.node_table[:width_ref1]}, (uint32)#{node.node_table[:width_ref2]}, (uint32)INTERPOLATE_LINEAR, (uint32)EXTRAPOLATE_CONST, (uint32)#{node.node_table[:kind]});")
end
    end
end
node = node_stack.pop()
