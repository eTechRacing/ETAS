...
/* The file must only be included for the implementation of code for TASK(Timer_Sync) */

#ifndef OS_TASK_Timer_Sync
#define OS_TASK_Timer_Sync
...
#define Timer_Sync_default_profile (0)	/* Profile */
...
#define TIMER_SYNC_response1 (0)	/* Critical execution */
