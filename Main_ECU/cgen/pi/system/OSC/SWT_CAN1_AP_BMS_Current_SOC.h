...
/* The file must only be included for the implementation of code for TASK(SWT_CAN1_AP_BMS_Current_SOC) */

#ifndef OS_TASK_SWT_CAN1_AP_BMS_Current_SOC
#define OS_TASK_SWT_CAN1_AP_BMS_Current_SOC
...
#endif /* OS_TASK_SWT_CAN1_AP_BMS_Current_SOC */
