...
/* crossbar hook in task 5 SWT_CAN1_AP_BMS_StateAndFailReport */
crossbarHookTableEntry crossbarHookTable5[1] = {NULL};

/* crossbar hook in task 6 SWT_CAN1_AP_BMS_Voltages */
crossbarHookTableEntry crossbarHookTable6[1] = {NULL};

/* crossbar hook in task 7 SWT_CAN1_AP_CurrentSensor */
crossbarHookTableEntry crossbarHookTable7[1] = {NULL};

/* crossbar hook in task 8 SWT_CAN1_AP_DASH_Cooling */
crossbarHookTableEntry crossbarHookTable8[1] = {NULL};

/* crossbar hook in task 9 SWT_CAN1_AP_DASH_CustomMode */
crossbarHookTableEntry crossbarHookTable9[1] = {NULL};

/* crossbar hook in task 10 SWT_CAN1_AP_DASH_EnableDrive */
crossbarHookTableEntry crossbarHookTable10[1] = {NULL};

/* crossbar hook in task 11 SWT_CAN1_AP_DASH_Mode */
crossbarHookTableEntry crossbarHookTable11[1] = {NULL};

/* crossbar hook in task 12 SWT_CAN1_AP_DASH_PrechargeRequest */
crossbarHookTableEntry crossbarHookTable12[1] = {NULL};

/* crossbar hook in task 13 SWT_CAN1_AP_DASH_TorqueLockOn */
crossbarHookTableEntry crossbarHookTable13[1] = {NULL};

/* crossbar hook in task 14 SWT_CAN1_AP_Inverter_L_Tx */
crossbarHookTableEntry crossbarHookTable14[1] = {NULL};

/* crossbar hook in task 15 SWT_CAN1_AP_Inverter_R_Tx */
...
/* crossbar hook in task 18 SWT_CAN2_AP_ELLIPSE_EKF_EULER */
crossbarHookTableEntry crossbarHookTable18[1] = {NULL};

/* crossbar hook in task 19 SWT_CAN2_AP_ELLIPSE_EKF_POS */
crossbarHookTableEntry crossbarHookTable19[1] = {NULL};

/* crossbar hook in task 20 SWT_CAN2_AP_ELLIPSE_EKF_VEL */
crossbarHookTableEntry crossbarHookTable20[1] = {NULL};

/* crossbar hook in task 21 SWT_CAN2_AP_ELLIPSE_IMU_ACCEL */
crossbarHookTableEntry crossbarHookTable21[1] = {NULL};

/* crossbar hook in task 22 SWT_CAN2_AP_ELLIPSE_IMU_GYRO */
crossbarHookTableEntry crossbarHookTable22[1] = {NULL};

/* crossbar hook in task 23 SWT_CAN2_AP_ELLIPSE_SLIP_CURV */
crossbarHookTableEntry crossbarHookTable23[1] = {NULL};

/* crossbar hook in task 24 SWT_CAN2_AP_FECU_Data1 */
crossbarHookTableEntry crossbarHookTable24[1] = {NULL};

/* crossbar hook in task 25 SWT_CAN2_AP_FECU_Data2 */
crossbarHookTableEntry crossbarHookTable25[1] = {NULL};

/* crossbar hook in task 26 SWT_CAN2_AP_RECU_Data */
crossbarHookTableEntry crossbarHookTable26[1] = {NULL};

/* crossbar hook in task 27 SWT_CAN2_MEAS_FECU_SDC */
crossbarHookTableEntry crossbarHookTable27[1] = {NULL};

/* crossbar hook in task 28 SWT_CAN2_MEAS_RECU_SDC */
crossbarHookTableEntry crossbarHookTable28[1] = {NULL};

/* crossbar hook in task 29 SWT_CAN2_NM_ELLIPSE_Status */
crossbarHookTableEntry crossbarHookTable29[1] = {NULL};

/* crossbar hook in task 30 SWT_CAN2_NM_FECU_Keep_Alive */
crossbarHookTableEntry crossbarHookTable30[1] = {NULL};

/* crossbar hook in task 31 SWT_CAN2_NM_RECU_Keep_Alive */
crossbarHookTableEntry crossbarHookTable31[1] = {NULL};

/* crossbar hook in task 32 Sync_25ms */
crossbarHookTableEntry crossbarHookTable32[2] = {NULL, NULL};

/* crossbar hook in task 33 Timer_1000ms */
crossbarHookTableEntry crossbarHookTable33[2] = {NULL, NULL};

/* crossbar hook in task 34 Timer_100ms */
crossbarHookTableEntry crossbarHookTable34[2] = {NULL, NULL};

/* crossbar hook in task 35 Timer_25ms */
crossbarHookTableEntry crossbarHookTable35[2] = {NULL, NULL};

/* crossbar hook in task 36 Timer_Inv */
crossbarHookTableEntry crossbarHookTable36[2] = {NULL, NULL};

/* crossbar hook in task 37 ISR_CAN1 */
crossbarHookTableEntry crossbarHookTable37[1] = {NULL};

/* crossbar hook in task 38 ISR_CAN2 */
crossbarHookTableEntry crossbarHookTable38[1] = {NULL};

/* crossbar hook in task 39 Init */
crossbarHookTableEntry crossbarHookTable39[6] = {NULL, NULL, NULL, NULL, NULL, NULL};

/* crossbar hook in task 40 Exit */
crossbarHookTableEntry crossbarHookTable40[6] = {NULL, NULL, NULL, NULL, NULL, NULL};


/* crossbar task table */
crossbarTaskTableEntry crossbarTaskTable[41] =
{
	{NULL},
