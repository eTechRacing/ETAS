...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_AP_ELIPSE_VelBody) */

#ifndef OS_TASK_SWT_CAN2_AP_ELIPSE_VelBody
#define OS_TASK_SWT_CAN2_AP_ELIPSE_VelBody
...
#endif /* OS_TASK_SWT_CAN2_AP_ELIPSE_VelBody */
