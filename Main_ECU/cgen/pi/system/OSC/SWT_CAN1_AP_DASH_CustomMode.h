...
/* The file must only be included for the implementation of code for TASK(SWT_CAN1_AP_DASH_CustomMode) */

#ifndef OS_TASK_SWT_CAN1_AP_DASH_CustomMode
#define OS_TASK_SWT_CAN1_AP_DASH_CustomMode
...
#endif /* OS_TASK_SWT_CAN1_AP_DASH_CustomMode */
