...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_AP_ELLIPSE_GPS_VEL) */

#ifndef OS_TASK_SWT_CAN2_AP_ELLIPSE_GPS_VEL
#define OS_TASK_SWT_CAN2_AP_ELLIPSE_GPS_VEL
...
#endif /* OS_TASK_SWT_CAN2_AP_ELLIPSE_GPS_VEL */
