...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_NM_FECU_Keep_Alive) */

#ifndef OS_TASK_SWT_CAN2_NM_FECU_Keep_Alive
#define OS_TASK_SWT_CAN2_NM_FECU_Keep_Alive
...
#endif /* OS_TASK_SWT_CAN2_NM_FECU_Keep_Alive */
