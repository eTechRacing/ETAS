...
/* The file must only be included for the implementation of code for TASK(SWT_CAN1_AP_CurrentSensor) */

#ifndef OS_TASK_SWT_CAN1_AP_CurrentSensor
#define OS_TASK_SWT_CAN1_AP_CurrentSensor
...
#endif /* OS_TASK_SWT_CAN1_AP_CurrentSensor */
