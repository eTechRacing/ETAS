...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_AP_ADCAN_Data2) */

#ifndef OS_TASK_SWT_CAN2_AP_ADCAN_Data2
#define OS_TASK_SWT_CAN2_AP_ADCAN_Data2
...
#endif /* OS_TASK_SWT_CAN2_AP_ADCAN_Data2 */
