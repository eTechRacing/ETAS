...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_AP_ELLIPSE_EKF_POS) */

#ifndef OS_TASK_SWT_CAN2_AP_ELLIPSE_EKF_POS
#define OS_TASK_SWT_CAN2_AP_ELLIPSE_EKF_POS
...
#endif /* OS_TASK_SWT_CAN2_AP_ELLIPSE_EKF_POS */
