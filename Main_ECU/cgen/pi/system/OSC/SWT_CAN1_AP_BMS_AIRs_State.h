...
/* The file must only be included for the implementation of code for TASK(SWT_CAN1_AP_BMS_AIRs_State) */

#ifndef OS_TASK_SWT_CAN1_AP_BMS_AIRs_State
#define OS_TASK_SWT_CAN1_AP_BMS_AIRs_State
...
#endif /* OS_TASK_SWT_CAN1_AP_BMS_AIRs_State */
