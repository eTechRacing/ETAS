...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_AP_ACCEL_F_Data) */

#ifndef OS_TASK_SWT_CAN2_AP_ACCEL_F_Data
#define OS_TASK_SWT_CAN2_AP_ACCEL_F_Data
...
#endif /* OS_TASK_SWT_CAN2_AP_ACCEL_F_Data */
