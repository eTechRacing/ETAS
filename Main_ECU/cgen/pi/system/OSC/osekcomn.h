...
#include "oscomn.h"
DeclareTask(SWT_CAN2_2024_AP_FECU_Data1);
DeclareTask(SWT_CAN2_2024_AP_FECU_Data2);
DeclareTask(SWT_CAN2_2024_NM_RECU_Keep_Alive);
DeclareTask(SWT_CAN2_2024_NM_FECU_Keep_Alive);
DeclareTask(SWT_CAN2_2024_AP_RECU_Data);
DeclareTask(SWT_CAN2_2024_AP_ELLIPSE_SLIP_CURV);
DeclareTask(SWT_CAN2_2024_AP_ELLIPSE_IMU_GYRO);
DeclareTask(SWT_CAN2_2024_NM_ELLIPSE_Status);
DeclareTask(SWT_CAN2_2024_AP_ELLIPSE_EKF_VEL);
DeclareTask(SWT_CAN2_2024_AP_ELLIPSE_EKF_EULER);
DeclareTask(SWT_CAN2_2024_AP_ELLIPSE_IMU_ACCEL);
DeclareTask(SWT_CAN2_2024_AP_ELLIPSE_EKF_POS);
DeclareTask(SWT_CAN2_2024_MEAS_FECU_SDC);
DeclareTask(SWT_CAN2_2024_MEAS_RECU_SDC);
DeclareTask(SWT_CAN1_2024_AP_DASH_EnableDrive);
DeclareTask(SWT_CAN1_2024_AP_DASH_PrechargeRequest);
DeclareTask(SWT_CAN1_2024_AP_DASH_TorqueLockOn);
DeclareTask(SWT_CAN1_2024_NM_DASH_Keep_Alive);
DeclareTask(SWT_CAN1_2024_AP_BMS_AIRs_State);
DeclareTask(SWT_CAN1_2024_NM_BMS_Keep_Alive);
DeclareTask(SWT_CAN1_2024_AP_DASH_Mode);
DeclareTask(SWT_CAN1_2024_AP_DASH_CustomMode);
DeclareTask(SWT_CAN1_2024_AP_Inverter_L_Tx);
DeclareTask(SWT_CAN1_2024_AP_Inverter_R_Tx);
DeclareTask(SWT_CAN1_2024_AP_BMS_BatteryTemperature);
DeclareTask(SWT_CAN1_2024_AP_BMS_ChargerParameters);
DeclareTask(SWT_CAN1_2024_AP_BMS_Voltages);
DeclareTask(SWT_CAN1_2024_AP_CurrentSensor);
DeclareTask(SWT_CAN1_2024_AP_BMS_SDC);
...
DeclareISR(ISR_CAN1_2024);
#define OS_ISR_PRI_ISR_CAN1_2024 (1)
#define OS_ISR_ARB_ISR_CAN1_2024 (1)
DeclareISR(ISR_CAN2_2024);
#define OS_ISR_PRI_ISR_CAN2_2024 (1)
#define OS_ISR_ARB_ISR_CAN2_2024 (0)
