...
#include "oscomn.h"
DeclareTask(SWT_CAN1_AP_BMS_OnBoardTemperatures1);
DeclareTask(SWT_CAN1_AP_BMS_Current_SOC_SOH1);
DeclareTask(SWT_CAN1_AP_BMS_Current_SOC);
DeclareTask(SWT_CAN2_AP_ELIPSE_VelBody);
DeclareTask(SWT_CAN2_AP_ELIPSE_VelAngular);
DeclareTask(SWT_CAN2_NM_ADCAN_Keep_Alive);
DeclareTask(SWT_CAN2_AP_ADCAN_Data1);
DeclareTask(SWT_CAN2_AP_ADCAN_Data2);
DeclareTask(SWT_CAN2_AP_ACCEL_R_Data);
DeclareTask(SWT_CAN2_NM_ACCEL_R_Keep_Alive);
DeclareTask(SWT_CAN2_NM_ACCEL_F_Keep_Alive);
DeclareTask(SWT_CAN2_AP_ACCEL_F_Data);
DeclareTask(SWT_CAN2_NM_LV_Derivation_Keep_Alive);
DeclareTask(SWT_CAN2_AP_ACCEL_R_Data2);
DeclareTask(SWT_CAN2_AP_LV_Derivation_LVData);
DeclareTask(SWT_CAN1_NM_SHUTDOWN_Keep_Alive);
DeclareTask(SWT_CAN1_AP_SHUTDOWN_State);
DeclareTask(SWT_CAN1_AP_DASH_EnableDrive);
DeclareTask(SWT_CAN1_AP_DASH_PrechargeRequest);
DeclareTask(SWT_CAN1_AP_DASH_TorqueLockOn);
DeclareTask(SWT_CAN1_NM_DASH_Keep_Alive);
DeclareTask(SWT_CAN1_NM_BMS_Keep_Alive);
DeclareTask(SWT_CAN1_AP_DASH_Mode);
DeclareTask(SWT_CAN1_AP_DASH_CustomMode);
DeclareTask(SWT_CAN1_AP_Inverter_L_Tx);
DeclareTask(SWT_CAN1_AP_Inverter_R_Tx);
DeclareTask(SWT_CAN1_AP_BMS_OnBoardTemperatures);
DeclareTask(SWT_CAN1_AP_BMS_Voltages);
DeclareTask(SWT_CAN1_AP_BMS_StateAndFailReport);
DeclareTask(SWT_CAN1_AP_BMS_Current_SOC_SOH);
DeclareTask(SWT_CAN1_AP_BMS_AIRs_State);
DeclareTask(SWT_CAN1_AP_BMS_BatteryTemperatures);
...
DeclareISR(NewISR);
#define OS_ISR_PRI_NewISR (1)
#define OS_ISR_ARB_NewISR (1)
DeclareISR(NewISR1);
#define OS_ISR_PRI_NewISR1 (1)
#define OS_ISR_ARB_NewISR1 (0)
