 ...
 * Last edited 'unknown'
 * File generated 'Mon Mar 25 19:49:30 2024'
...
#define osek_task_SWT_CAN1_AP_DASH_TorqueLockOn (&OS_L0043)
...
#define osek_task_SWT_CAN1_AP_DASH_CustomMode (&OS_L0048)
...
#define osek_task_SWT_CAN1_AP_BMS_BatteryTemperatures (&OS_L004B)
...
#define osek_task_SWT_CAN1_AP_BMS_StateAndFailReport (&OS_L004E)
extern struct os_task OS_L004F;
#define osek_task_SWT_CAN1_AP_CurrentSensor (&OS_L004F)
extern struct os_task OS_L0050;
#define osek_task_SWT_CAN1_AP_DASH_Cooling (&OS_L0050)
extern struct os_task OS_L0051;
#define osek_task_SWT_CAN1_AP_BMS_SDC (&OS_L0051)
extern struct os_task OS_L0052;
#define osek_task_Sync_25ms (&OS_L0052)
extern struct os_task OS_L0053;
#define osek_task_Timer_1000ms (&OS_L0053)
extern struct os_task OS_L0054;
#define osek_task_Timer_100ms (&OS_L0054)
extern struct os_task OS_L0055;
#define osek_task_Timer_25ms (&OS_L0055)
extern struct os_task OS_L0056;
#define osek_task_Timer_Inv (&OS_L0056)
extern struct os_task OS_L0057;
#define osek_task_etasL1Task (&OS_L0057)
extern struct os_task OS_L0058;
#define osek_task_etasConfigTask (&OS_L0058)

/* ISR handles */
extern struct os_task OS_L005C;
#define osek_interrupt_etasTimerIsr (&OS_L005C)
extern struct os_task OS_L005D;
#define osek_interrupt_etasL1Isr (&OS_L005D)
extern struct os_task OS_L005E;
#define osek_interrupt_etasStopOsIsr (&OS_L005E)
extern struct os_task OS_L005F;
#define osek_interrupt_etasActivateTaskIsr (&OS_L005F)
extern struct os_task OS_L0060;
#define osek_interrupt_ISR_CAN1 (&OS_L0060)
extern struct os_task OS_L0061;
#define osek_interrupt_ISR_CAN2 (&OS_L0061)
