...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_MEAS_FECU_SDC) */

#ifndef OS_TASK_SWT_CAN2_MEAS_FECU_SDC
#define OS_TASK_SWT_CAN2_MEAS_FECU_SDC
...
#endif /* OS_TASK_SWT_CAN2_MEAS_FECU_SDC */
