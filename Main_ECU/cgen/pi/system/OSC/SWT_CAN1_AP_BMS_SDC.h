...
/* The file must only be included for the implementation of code for TASK(SWT_CAN1_AP_BMS_SDC) */

#ifndef OS_TASK_SWT_CAN1_AP_BMS_SDC
#define OS_TASK_SWT_CAN1_AP_BMS_SDC
...
#endif /* OS_TASK_SWT_CAN1_AP_BMS_SDC */
