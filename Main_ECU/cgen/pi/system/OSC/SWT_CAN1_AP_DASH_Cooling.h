...
/* The file must only be included for the implementation of code for TASK(SWT_CAN1_AP_DASH_Cooling) */

#ifndef OS_TASK_SWT_CAN1_AP_DASH_Cooling
#define OS_TASK_SWT_CAN1_AP_DASH_Cooling
...
#define SWT_CAN1_AP_DASH_Cooling_default_profile (0)	/* Profile */
...
#define ActivateTask_SWT_CAN1_AP_DASH_Cooling() ActivateTask(SWT_CAN1_AP_DASH_Cooling)
#define ChainTask_SWT_CAN1_AP_DASH_Cooling() ChainTask(SWT_CAN1_AP_DASH_Cooling)
...
#endif /* OS_TASK_SWT_CAN1_AP_DASH_Cooling */
