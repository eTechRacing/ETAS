...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_AP_FECU_Data1) */

#ifndef OS_TASK_SWT_CAN2_AP_FECU_Data1
#define OS_TASK_SWT_CAN2_AP_FECU_Data1
...
#endif /* OS_TASK_SWT_CAN2_AP_FECU_Data1 */
