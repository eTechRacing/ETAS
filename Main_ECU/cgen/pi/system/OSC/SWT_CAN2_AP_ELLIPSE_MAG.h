...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_AP_ELLIPSE_MAG) */

#ifndef OS_TASK_SWT_CAN2_AP_ELLIPSE_MAG
#define OS_TASK_SWT_CAN2_AP_ELLIPSE_MAG
...
#endif /* OS_TASK_SWT_CAN2_AP_ELLIPSE_MAG */
