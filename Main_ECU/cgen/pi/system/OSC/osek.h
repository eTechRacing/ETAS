...
#define SWT_CAN1_AP_BMS_Current_SOC_default_profile (0)	/* Profile */
#define SWT_CAN1_AP_BMS_Current_SOC_SOH_default_profile (0)	/* Profile */
#define SWT_CAN1_AP_BMS_Current_SOC_SOH1_default_profile (0)	/* Profile */
#define SWT_CAN1_AP_BMS_OnBoardTemperatures_default_profile (0)	/* Profile */
#define SWT_CAN1_AP_BMS_OnBoardTemperatures1_default_profile (0)	/* Profile */
...
#define SWT_CAN2_AP_ELIPSE_VelAngular_default_profile (0)	/* Profile */
#define SWT_CAN2_AP_ELIPSE_VelBody_default_profile (0)	/* Profile */
...
#define NewISR_default_profile (0)	/* Profile */
#define NewISR1_default_profile (0)	/* Profile */
