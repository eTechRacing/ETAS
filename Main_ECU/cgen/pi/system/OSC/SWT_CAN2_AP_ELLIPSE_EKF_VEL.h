...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_AP_ELLIPSE_EKF_VEL) */

#ifndef OS_TASK_SWT_CAN2_AP_ELLIPSE_EKF_VEL
#define OS_TASK_SWT_CAN2_AP_ELLIPSE_EKF_VEL
...
#endif /* OS_TASK_SWT_CAN2_AP_ELLIPSE_EKF_VEL */
