...
/* The file must only be included for the implementation of code for TASK(SWT_CAN1_AP_DASH_Mode) */

#ifndef OS_TASK_SWT_CAN1_AP_DASH_Mode
#define OS_TASK_SWT_CAN1_AP_DASH_Mode
...
#endif /* OS_TASK_SWT_CAN1_AP_DASH_Mode */
