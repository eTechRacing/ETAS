...
/* The file must only be included for the implementation of code for TASK(SWT_CAN1_AP_Inverter_R_Tx) */

#ifndef OS_TASK_SWT_CAN1_AP_Inverter_R_Tx
#define OS_TASK_SWT_CAN1_AP_Inverter_R_Tx
...
#endif /* OS_TASK_SWT_CAN1_AP_Inverter_R_Tx */
