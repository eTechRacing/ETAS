...
/* rtio hook in task 14 SWT_CAN2_AP_ELLIPSE_AUTO */
rtioHookTableEntry rtioHookTable14[1] = {NULL};

/* rtio hook in task 15 SWT_CAN2_AP_ELLIPSE_EKF_EULER */
rtioHookTableEntry rtioHookTable15[1] = {NULL};

/* rtio hook in task 16 SWT_CAN2_AP_ELLIPSE_EKF_POS */
rtioHookTableEntry rtioHookTable16[1] = {NULL};

/* rtio hook in task 17 SWT_CAN2_AP_ELLIPSE_EKF_VEL */
rtioHookTableEntry rtioHookTable17[1] = {NULL};

/* rtio hook in task 18 SWT_CAN2_AP_ELLIPSE_GPS_VEL */
...
/* rtio hook in task 21 SWT_CAN2_AP_ELLIPSE_VEL_Valid */
