...
/* rtio hook in task 5 SWT_CAN1_AP_BMS_StateAndFailReport */
rtioHookTableEntry rtioHookTable5[1] = {NULL};

/* rtio hook in task 6 SWT_CAN1_AP_BMS_Voltages */
rtioHookTableEntry rtioHookTable6[1] = {NULL};

/* rtio hook in task 7 SWT_CAN1_AP_CurrentSensor */
rtioHookTableEntry rtioHookTable7[1] = {NULL};

/* rtio hook in task 8 SWT_CAN1_AP_DASH_Cooling */
rtioHookTableEntry rtioHookTable8[1] = {NULL};

/* rtio hook in task 9 SWT_CAN1_AP_DASH_CustomMode */
rtioHookTableEntry rtioHookTable9[1] = {NULL};

/* rtio hook in task 10 SWT_CAN1_AP_DASH_EnableDrive */
rtioHookTableEntry rtioHookTable10[1] = {NULL};

/* rtio hook in task 11 SWT_CAN1_AP_DASH_Mode */
rtioHookTableEntry rtioHookTable11[1] = {NULL};

/* rtio hook in task 12 SWT_CAN1_AP_DASH_PrechargeRequest */
rtioHookTableEntry rtioHookTable12[1] = {NULL};

/* rtio hook in task 13 SWT_CAN1_AP_DASH_TorqueLockOn */
rtioHookTableEntry rtioHookTable13[1] = {NULL};

/* rtio hook in task 14 SWT_CAN1_AP_Inverter_L_Tx */
rtioHookTableEntry rtioHookTable14[1] = {NULL};

/* rtio hook in task 15 SWT_CAN1_AP_Inverter_R_Tx */
...
/* rtio hook in task 18 SWT_CAN2_AP_ELLIPSE_EKF_EULER */
rtioHookTableEntry rtioHookTable18[1] = {NULL};

/* rtio hook in task 19 SWT_CAN2_AP_ELLIPSE_EKF_POS */
rtioHookTableEntry rtioHookTable19[1] = {NULL};

/* rtio hook in task 20 SWT_CAN2_AP_ELLIPSE_EKF_VEL */
rtioHookTableEntry rtioHookTable20[1] = {NULL};

/* rtio hook in task 21 SWT_CAN2_AP_ELLIPSE_IMU_ACCEL */
rtioHookTableEntry rtioHookTable21[1] = {NULL};

/* rtio hook in task 22 SWT_CAN2_AP_ELLIPSE_IMU_GYRO */
rtioHookTableEntry rtioHookTable22[1] = {NULL};

/* rtio hook in task 23 SWT_CAN2_AP_ELLIPSE_SLIP_CURV */
rtioHookTableEntry rtioHookTable23[1] = {NULL};

/* rtio hook in task 24 SWT_CAN2_AP_FECU_Data1 */
rtioHookTableEntry rtioHookTable24[1] = {NULL};

/* rtio hook in task 25 SWT_CAN2_AP_FECU_Data2 */
rtioHookTableEntry rtioHookTable25[1] = {NULL};

/* rtio hook in task 26 SWT_CAN2_AP_RECU_Data */
rtioHookTableEntry rtioHookTable26[1] = {NULL};

/* rtio hook in task 27 SWT_CAN2_MEAS_FECU_SDC */
rtioHookTableEntry rtioHookTable27[1] = {NULL};

/* rtio hook in task 28 SWT_CAN2_MEAS_RECU_SDC */
rtioHookTableEntry rtioHookTable28[1] = {NULL};

/* rtio hook in task 29 SWT_CAN2_NM_ELLIPSE_Status */
rtioHookTableEntry rtioHookTable29[1] = {NULL};

/* rtio hook in task 30 SWT_CAN2_NM_FECU_Keep_Alive */
rtioHookTableEntry rtioHookTable30[1] = {NULL};

/* rtio hook in task 31 SWT_CAN2_NM_RECU_Keep_Alive */
rtioHookTableEntry rtioHookTable31[1] = {NULL};

/* rtio hook in task 32 Sync_25ms */
rtioHookTableEntry rtioHookTable32[1] = {NULL};

/* rtio hook in task 33 Timer_1000ms */
rtioHookTableEntry rtioHookTable33[1] = {NULL};

/* rtio hook in task 34 Timer_100ms */
rtioHookTableEntry rtioHookTable34[1] = {NULL};

/* rtio hook in task 35 Timer_25ms */
rtioHookTableEntry rtioHookTable35[1] = {NULL};

/* rtio hook in task 36 Timer_Inv */
rtioHookTableEntry rtioHookTable36[1] = {NULL};

/* rtio hook in task 37 ISR_CAN1 */
rtioHookTableEntry rtioHookTable37[1] = {NULL};

/* rtio hook in task 38 ISR_CAN2 */
rtioHookTableEntry rtioHookTable38[1] = {NULL};

/* rtio hook in task 39 Init */
rtioHookTableEntry rtioHookTable39[1] = {NULL};

/* rtio hook in task 40 Exit */
rtioHookTableEntry rtioHookTable40[1] = {NULL};


/* rtio task table */
rtioTaskTableEntry rtioTaskTable[41] =
{
	{&rtioHookTable0[0]},
	{&rtioHookTable1[0]},
	{&rtioHookTable2[0]},
