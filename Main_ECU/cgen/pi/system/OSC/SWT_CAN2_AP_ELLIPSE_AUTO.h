...
/* The file must only be included for the implementation of code for TASK(SWT_CAN2_AP_ELLIPSE_AUTO) */

#ifndef OS_TASK_SWT_CAN2_AP_ELLIPSE_AUTO
#define OS_TASK_SWT_CAN2_AP_ELLIPSE_AUTO
...
#define SWT_CAN2_AP_ELLIPSE_AUTO_default_profile (0)	/* Profile */
...
#define OSALARM_TIMER_SYNC (0)	/* Alarm */
...
#endif /* OS_TASK_SWT_CAN2_AP_ELLIPSE_AUTO */
