...
void initClass_RTWTop_Disconnections(struct RTWTop_Disconnections_Class *self)
{
    ...
    self->RTWWrapper_Disconnections_B_Merge_b_Ptr = initInstance_scalarWrapper((void*)&Disconnections_B.Merge_b, sizeof(double), (uint32)ASD_VARIABLE);
    ...
    self->RTWWrapper_Disconnections_B_Merge_f_Ptr = initInstance_scalarWrapper((void*)&Disconnections_B.Merge_f, sizeof(double), (uint32)ASD_VARIABLE);
    self->RTWWrapper_Disconnections_B_Merge_h_Ptr = initInstance_scalarWrapper((void*)&Disconnections_B.Merge_h, sizeof(double), (uint32)ASD_VARIABLE);
    ...
    self->RTWWrapper_Disconnections_DW_Last_alive_a_Ptr = initInstance_scalarWrapper((void*)&Disconnections_DW.Last_alive_a, sizeof(double), (uint32)ASD_VARIABLE);
    self->RTWWrapper_Disconnections_DW_Last_alive_c_Ptr = initInstance_scalarWrapper((void*)&Disconnections_DW.Last_alive_c, sizeof(double), (uint32)ASD_VARIABLE);
    self->RTWWrapper_Disconnections_DW_Last_alive_c0_Ptr = initInstance_scalarWrapper((void*)&Disconnections_DW.Last_alive_c0, sizeof(double), (uint32)ASD_VARIABLE);
    ...
    self->RTWWrapper_Disconnections_DW_Last_alive_gx_Ptr = initInstance_scalarWrapper((void*)&Disconnections_DW.Last_alive_gx, sizeof(double), (uint32)ASD_VARIABLE);
    self->RTWWrapper_Disconnections_DW_Last_alive_j_Ptr = initInstance_scalarWrapper((void*)&Disconnections_DW.Last_alive_j, sizeof(double), (uint32)ASD_VARIABLE);
    ...
    self->RTWWrapper_Disconnections_DW_Tot_Errors_j_Ptr = initInstance_scalarWrapper((void*)&Disconnections_DW.Tot_Errors_j, sizeof(double), (uint32)ASD_VARIABLE);
    self->RTWWrapper_Disconnections_DW_Tot_Errors_k_Ptr = initInstance_scalarWrapper((void*)&Disconnections_DW.Tot_Errors_k, sizeof(double), (uint32)ASD_VARIABLE);
    ...
    self->RTWWrapper_Disconnections_U_BrakeSensor_Bits_Ptr = initInstance_scalarWrapper((void*)&Disconnections_U.BrakeSensor_Bits, sizeof(double), (uint32)ASD_VARIABLE);
    ...
    self->RTWWrapper_Disconnections_Y_CounterOut_Ptr = initInstance_scalarWrapper((void*)&Disconnections_Y.CounterOut, sizeof(double), (uint32)ASD_VARIABLE);
    ...
    self->RTWWrapper_Disconnections_Y_Disconnection_Brake_Sensor_Ptr = initInstance_scalarWrapper((void*)&Disconnections_Y.Disconnection_Brake_Sensor, sizeof(double), (uint32)ASD_VARIABLE);
