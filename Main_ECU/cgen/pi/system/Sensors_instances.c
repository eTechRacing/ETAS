...
void initClass_RTWTop_Sensors(struct RTWTop_Sensors_Class *self)
{
    ...
    self->RTWWrapper_Sensors_ConstB_Sum1_p_Ptr = initInstance_scalarWrapper((void*)&Sensors_ConstB.Sum1_p, sizeof(double), (uint32)ASD_VARIABLE);
...
static ASDClassHeader RTWTop_Sensors_ClassHeader =
    {0, 1, 0, 27 + 0, (MethodList *)0, (MethodList *)&RTWTop_Sensors_ClassMethodList};
