...
struct RTWTop_VDC_Class
{
    ...
    scalarWrapper_Obj *RTWWrapper_VDC_DW_A_Ptr;
    ...
    scalarWrapper_Obj *RTWWrapper_VDC_U_Accumulator_Current_Ptr;
    ...
    scalarWrapper_Obj *RTWWrapper_VDC_Y_Power_Ptr;
    scalarWrapper_Obj *RTWWrapper_VDC_Y_PowerLimitReached_Ptr;
    ...
    scalarWrapper_Obj *RTWWrapper_VDC_Y_Torque_R_out_Ptr;
};
