...
struct RTWTop_SoC_Class
{
    ...
    scalarWrapper_Obj *RTWWrapper_SoC_B_CellOCVtoSOC1_Ptr;
    ...
    matrixWrapper_Obj *RTWWrapper_SoC_B_uRC_Cell_H_0__CoreSubsys_Pdot_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_B_uRC_Cell_H_0__CoreSubsys_Sum2_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC_Cell_H_0__CoreSubsys_Sum2_h_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC_Cell_H_0__CoreSubsys_TmpSignalConversionAtIntegrator_Ptr;
    matrixWrapper_Obj *RTWWrapper_SoC_B_uRC_Cell_L_0__CoreSubsys_Pdot_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_B_uRC_Cell_L_0__CoreSubsys_Sum2_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC_Cell_L_0__CoreSubsys_Sum2_h_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC_Cell_L_0__CoreSubsys_TmpSignalConversionAtIntegrator_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_ConstB_CoreSubsys_Divide_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_ConstB_uRC_Cell_H_CoreSubsys_Divide_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_ConstB_uRC_Cell_L_CoreSubsys_Divide_Ptr;
