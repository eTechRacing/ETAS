...
struct RTWTop_SoC_Class
{
    ...
    vectorWrapper_Obj *RTWWrapper_SoC_B_CoreSubsys_j_0__Probe_Ptr;
    matrixWrapper_Obj *RTWWrapper_SoC_B_CoreSubsys_j_0__Product5_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_CoreSubsys_j_0__Sum_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_CoreSubsys_j_0__TmpSignalConversionAtDelayInpor_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_B_CoreSubsys_l_0__Gain_Ptr;
    ...
    scalarWrapper_Obj *RTWWrapper_SoC_ConstB_Saturation_Ptr;
