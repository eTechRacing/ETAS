...
struct RTWTop_SoC_Class
{
    ...
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC1_0__CoreSubsys_Probe_Ptr;
    matrixWrapper_Obj *RTWWrapper_SoC_B_uRC1_0__CoreSubsys_Product5_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC1_0__CoreSubsys_Sum_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC1_0__CoreSubsys_TmpSignalConversionAtDelayInpor_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC1_p_0__CoreSubsys_Probe_Ptr;
    matrixWrapper_Obj *RTWWrapper_SoC_B_uRC1_p_0__CoreSubsys_Product5_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC1_p_0__CoreSubsys_Sum_Ptr;
    vectorWrapper_Obj *RTWWrapper_SoC_B_uRC1_p_0__CoreSubsys_TmpSignalConversionAtDelayInpor_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_U_Accumulator_Current_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_U_Car_State_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_U_Highest_CellTemp_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_U_Highest_CellVoltage_Ptr;
    scalarWrapper_Obj *RTWWrapper_SoC_U_Lowest_CellTemp_Ptr;
