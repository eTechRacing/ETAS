/*
 * File    : racing_modes_R2022a_main.c
 *
 * Abstract:
 ...
 * Visible functions *
 *===================*/
void irt_Terminate_racing_modes_R2022a();

/* Function: irt_Start_racing_modes_R2022a ========================================================
 *
 * Abstract:
 ...
 *
 */
void irt_Start_racing_modes_R2022a()
{
  const char *status;
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model racing_modes_R2022a **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_racing_modes_R2022a */

/* Function: irt_OneStep_racing_modes_R2022a ======================================================
 *
 * Abstract:
 ...
 *
 */
void irt_OneStep_racing_modes_R2022a()
{
  if (errorFlag) {
    return;
  }
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_racing_modes_R2022a */

/* Function: irt_Terminate_racing_modes_R2022a ====================================================
 *
 * Abstract:
...
}                                    /* end irt_Terminate_racing_modes_R2022a */

/* EOF: racing_modes_R2022a_main.c */
