 ...
 * C source code generated on : Thu Mar 28 11:15:52 2024
 *
...
typedef struct {
  ...
  const uint16_T b7tob0;               /* '<S14>/Bitwise Operator' */
  const uint16_T ShiftArithmetic;      /* '<S14>/Shift Arithmetic' */
  const uint16_T BitwiseOperator1;     /* '<S14>/Bitwise Operator1' */
