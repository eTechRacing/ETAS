 ...
 * Visible functions *
 *===================*/
void irt_Terminate_vdc_r2022a();

/* Function: irt_Start_vdc_r2022a ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model vdc_r2022a **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_vdc_r2022a */

/* Function: irt_OneStep_vdc_r2022a ======================================================
 *
 * Abstract:
...
void irt_OneStep_vdc_r2022a()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_vdc_r2022a */

/* Function: irt_Terminate_vdc_r2022a ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_vdc_r2022a */

/* EOF: vdc_r2022a_main.c */
