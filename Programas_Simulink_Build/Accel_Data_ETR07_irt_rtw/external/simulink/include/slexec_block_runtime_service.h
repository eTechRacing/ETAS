 ...
 *
 */
#define ssSetNumTicksToNextHitForVariableDiscrete(S, st_index, numTicks)                                                       \
{                                                                                                                              \
      double tmp = (double) numTicks;                                                                                          \
      _slexecSafelyCallBlkRTSGatewayStart(S)(S, SLEXEC_BLK_RTS_SET_NUM_TICKS_TO_NEXT_SAMPLE_HIT_FOR_VDR, (int) st_index, &tmp) \
 ...
 *
 */
#define ssGetNumTicksToNextHitForVariableDiscrete(S, st_index)                                                                         \
      _slexecSafelyCallBlkRTSGatewayStart(S)(S, SLEXEC_BLK_RTS_GET_NUM_TICKS_TO_NEXT_SAMPLE_HIT_FOR_VDR, (int) st_index, (void*) NULL) \
      _slexecSafelyCallBlkRTSGatewayEnd                                                                                                \
