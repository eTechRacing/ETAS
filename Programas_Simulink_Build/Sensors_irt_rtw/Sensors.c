...
static void Sensors_output(void)
{
   ...
   *  Sum: '<S3>/Sum'
   */
  rtb_Divide = (Sensors_U.BrakeSensor_Bits - 92.0) / Sensors_ConstB.Sum1;
   ...
   *  Sum: '<S1>/Sum'
   */
  Sensors_Y.APPS1_Value = (Sensors_U.APPS1_Bits - 5.0) / Sensors_ConstB.Sum1_p;
   ...
   *  Sum: '<S2>/Sum'
   */
  Sensors_Y.APPS2_Value = (Sensors_U.APPS2_Bits - 5.0) / Sensors_ConstB.Sum1_f;
   ...
   *  Sum: '<S5>/Sum'
   */
  Sensors_DW.Previous_IN = (Sensors_U.SteeringSensor_Bits - 570.0) * 2.0 /
    1000.0 * 115.0;
