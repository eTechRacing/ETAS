 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Torque_Control();

/* Function: irt_Start_Torque_Control ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Torque_Control **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Torque_Control */

/* Function: irt_OneStep_Torque_Control ======================================================
 *
 * Abstract:
 ...
 *
 */
void irt_OneStep_Torque_Control()
{
  if (errorFlag) {
    return;
  }
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Torque_Control */

/* Function: irt_Terminate_Torque_Control ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Torque_Control */

/* EOF: Torque_Control_main.c */
