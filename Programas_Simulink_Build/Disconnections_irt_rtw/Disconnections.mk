...
MODULES              = Disconnections_data.c Disconnections_main.c
...
TID01EQ              = 0
NCSTATES             = 0
BUILDARGS            =  MODELLIB=Disconnectionslib.lib MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING RELATIVE_PATH_TO_ANCHOR=.. MAT_FILE=0 IRTWaitForStartMsg=0
MULTITASKING         = 0
EXT_MODE             = 0
