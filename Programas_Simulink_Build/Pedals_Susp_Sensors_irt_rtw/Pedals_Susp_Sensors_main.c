/*
 * File    : Pedals_Susp_Sensors_main.c
 *
 * Abstract:
 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Pedals_Susp_Sensors();

/* Function: irt_Start_Pedals_Susp_Sensors ========================================================
 *
 * Abstract:
 ...
 *
 */
void irt_Start_Pedals_Susp_Sensors()
{
  const char *status;
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Pedals_Susp_Sensors **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Pedals_Susp_Sensors */

/* Function: irt_OneStep_Pedals_Susp_Sensors ======================================================
 *
 * Abstract:
 ...
 *
 */
void irt_OneStep_Pedals_Susp_Sensors()
{
  if (errorFlag) {
    return;
  }
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Pedals_Susp_Sensors */

/* Function: irt_Terminate_Pedals_Susp_Sensors ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Pedals_Susp_Sensors */

/* EOF: Pedals_Susp_Sensors_main.c */
