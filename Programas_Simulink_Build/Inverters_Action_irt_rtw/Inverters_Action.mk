...
# make matlab happy
MODEL                = Inverters_Action
MODULES              = Inverters_Action_data.c Inverters_Action_main.c
MAKEFILE             = Inverters_Action.mk
...
TID01EQ              = 0
NCSTATES             = 0
BUILDARGS            =  MODELLIB=Inverters_Actionlib.lib MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING RELATIVE_PATH_TO_ANCHOR=.. MAT_FILE=0 IRTWaitForStartMsg=0
MULTITASKING         = 0
EXT_MODE             = 0
