 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Inverters_Action();

/* Function: irt_Start_Inverters_Action ========================================================
 *
 * Abstract:
 ...
 *
 */
void irt_Start_Inverters_Action()
{
  const char *status;
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Inverters_Action **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Inverters_Action */

/* Function: irt_OneStep_Inverters_Action ======================================================
 *
 * Abstract:
 ...
 *
 */
void irt_OneStep_Inverters_Action()
{
  if (errorFlag) {
    return;
  }
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Inverters_Action */

/* Function: irt_Terminate_Inverters_Action ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Inverters_Action */

/* EOF: Inverters_Action_main.c */
