...
typedef struct {
  ...
  const real_T Divide_k;               /* '<S8>/Divide' */
} ConstB_Inverters_Data_T;

/* External inputs (root inport signals with default storage) */
typedef struct {
  real_T Inv_L_RegID_M48_Inv_L_Speed; /* '<Root>/Inv_L_RegID_M48_Inv_L_Speed' */
  real_T Inv_L_RegID_M73_Inv_L_TempMotor;
                                  /* '<Root>/Inv_L_RegID_M73_Inv_L_TempMotor' */
  real_T Inv_L_RegID_M74_Inv_L_TempIGBT;
...
#define tConstBlockIOType              ConstB_Inverters_Data_T
#define rtC                            Inverters_Data_ConstB
...
extern ConstB_Inverters_Data_T Inverters_Data_ConstB;/* constant block i/o */
