...
# make matlab happy
MODEL                = Inverters_Data
MODULES              = Inverters_Data_data.c Inverters_Data_main.c
MAKEFILE             = Inverters_Data.mk
...
TID01EQ              = 0
NCSTATES             = 0
BUILDARGS            =  MODELLIB=Inverters_Datalib.lib MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING RELATIVE_PATH_TO_ANCHOR=.. MAT_FILE=0 IRTWaitForStartMsg=0
MULTITASKING         = 0
EXT_MODE             = 0
