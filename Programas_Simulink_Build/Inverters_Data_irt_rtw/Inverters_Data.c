...
static void Inverters_Data_output(void)
{
   ...
   */
  rtb_RPMtorads = ((Inverters_Data_U.Inv_L_RegID_M74_Inv_L_TempIGBT *
                    Inverters_Data_U.Inv_L_RegID_M74_Inv_L_TempIGBT * -6.6188E-6
                    + rt_powd_snf
                    (Inverters_Data_U.Inv_L_RegID_M74_Inv_L_TempIGBT, 3.0) *
                    9.69483E-11) +
                   Inverters_Data_U.Inv_L_RegID_M74_Inv_L_TempIGBT * 0.158535) +
    -1260.62;
   ...
   *  MinMax: '<Root>/Max'
   */
  Inverters_Data_Y.Temp_IGBT = fmax(rtb_RPMtorads, rtb_RPMtorads_n);
   ...
   */
  rtb_RPMtorads = Inverters_Data_U.Inv_R_RegID_M73_Inv_R_TempMotor * 0.03282 +
    -114.92892;

  /* Outport: '<Root>/Temp_Motors' incorporates:
   *  MinMax: '<Root>/Max1'
   */
  Inverters_Data_Y.Temp_Motors = fmax(rtb_RPMtorads_n, rtb_RPMtorads);
  ...
  /* Gain: '<S13>/RPM to rad//s' incorporates:
   *  Inport: '<Root>/Inv_L_RegID_M48_Inv_L_Speed'
   *  Product: '<S8>/Product'
   */
  rtb_RPMtorads_n = Inverters_Data_U.Inv_L_RegID_M48_Inv_L_Speed *
    Inverters_Data_ConstB.Divide_k * 0.10471975511965977;

  /* Gain: '<S12>/RPM to rad//s' incorporates:
   *  Inport: '<Root>/Inv_R_RegID_M48_Inv_R_Speed'
   *  Product: '<S2>/Product'
   */
  rtb_RPMtorads = Inverters_Data_U.Inv_R_RegID_M48_Inv_R_Speed *
    Inverters_Data_ConstB.Divide * 0.10471975511965977;
   ...
   *  Sum: '<S10>/Add'
   */
  Inverters_Data_Y.Mech_Power = rtb_RPMtorads_n * Inverters_Data_U.Torque_L +
    rtb_RPMtorads * Inverters_Data_U.Torque_R;
  ...
  Inverters_Data_Y.Wheel_RR_Speed = rtb_Divide_g;

  /* Outport: '<Root>/Wheel_RL_Speed' */
  Inverters_Data_Y.Wheel_RL_Speed = rtb_Divide;
...
RT_MODEL_Inverters_Data_T *Inverters_Data(void)
{
  ...
  Inverters_Data_M->Sizes.numBlocks = (87);/* Number of blocks */
