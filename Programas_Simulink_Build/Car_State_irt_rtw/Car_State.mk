...
# make matlab happy
MODEL                = Car_State
MODULES              = Car_State_data.c Car_State_main.c
MAKEFILE             = Car_State.mk
...
TID01EQ              = 0
NCSTATES             = 0
BUILDARGS            =  MODELLIB=Car_Statelib.lib MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING RELATIVE_PATH_TO_ANCHOR=.. MAT_FILE=0 IRTWaitForStartMsg=0
MULTITASKING         = 0
EXT_MODE             = 0
