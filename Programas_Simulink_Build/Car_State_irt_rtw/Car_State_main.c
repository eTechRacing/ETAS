 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Car_State();

/* Function: irt_Start_Car_State ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Car_State **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Car_State */

/* Function: irt_OneStep_Car_State ======================================================
 *
 * Abstract:
...
void irt_OneStep_Car_State()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Car_State */

/* Function: irt_Terminate_Car_State ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Car_State */

/* EOF: Car_State_main.c */
