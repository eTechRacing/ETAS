 ...
 * Visible functions *
 *===================*/
void irt_Terminate_LVD_Data();

/* Function: irt_Start_LVD_Data ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model LVD_Data **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_LVD_Data */

/* Function: irt_OneStep_LVD_Data ======================================================
 *
 * Abstract:
...
void irt_OneStep_LVD_Data()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_LVD_Data */

/* Function: irt_Terminate_LVD_Data ====================================================
 *
 * Abstract:
