...
# make matlab happy
MODEL                = LVD_Data
MODULES              = LVD_Data_data.c LVD_Data_main.c
MAKEFILE             = LVD_Data.mk
...
TID01EQ              = 0
NCSTATES             = 0
BUILDARGS            =  MODELLIB=LVD_Datalib.lib MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING RELATIVE_PATH_TO_ANCHOR=.. MAT_FILE=0 IRTWaitForStartMsg=0
MULTITASKING         = 0
EXT_MODE             = 0
