 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Accel_Data();

/* Function: irt_Start_Accel_Data ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Accel_Data **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Accel_Data */

/* Function: irt_OneStep_Accel_Data ======================================================
 *
 * Abstract:
...
void irt_OneStep_Accel_Data()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Accel_Data */

/* Function: irt_Terminate_Accel_Data ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Accel_Data */

/* EOF: Accel_Data_main.c */
