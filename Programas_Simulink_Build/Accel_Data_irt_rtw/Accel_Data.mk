...
# make matlab happy
MODEL                = Accel_Data
MODULES              = Accel_Data_data.c Accel_Data_main.c
MAKEFILE             = Accel_Data.mk
...
TID01EQ              = 0
NCSTATES             = 0
BUILDARGS            =  MODELLIB=Accel_Datalib.lib MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING RELATIVE_PATH_TO_ANCHOR=.. MAT_FILE=0 IRTWaitForStartMsg=0
MULTITASKING         = 0
EXT_MODE             = 0
