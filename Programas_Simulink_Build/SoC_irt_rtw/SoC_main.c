 ...
 * Visible functions *
 *===================*/
void irt_Terminate_SoC();

/* Function: irt_Start_SoC ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model SoC **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
