/*
 * File    : Disconnections_ETR07_main.c
 *
 * Abstract:
 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Disconnections_ETR07();

/* Function: irt_Start_Disconnections_ETR07 ========================================================
 *
 * Abstract:
 ...
 *
 */
void irt_Start_Disconnections_ETR07()
{
  const char *status;
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Disconnections_ETR07 **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Disconnections_ETR07 */

/* Function: irt_OneStep_Disconnections_ETR07 ======================================================
 *
 * Abstract:
 ...
 *
 */
void irt_OneStep_Disconnections_ETR07()
{
  if (errorFlag) {
    return;
  }
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Disconnections_ETR07 */

/* Function: irt_Terminate_Disconnections_ETR07 ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Disconnections_ETR07 */

/* EOF: Disconnections_ETR07_main.c */
