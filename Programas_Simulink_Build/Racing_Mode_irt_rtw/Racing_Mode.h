...
/* Block signals for system '<S2>/Apps_Sat_Dwn' */
typedef struct {
  real_T Gain;                         /* '<S8>/Gain' */
} B_Apps_Sat_Dwn_Racing_Mode_T;
...
typedef struct {
  ...
  B_Apps_Sat_Dwn_Racing_Mode_T K_Reduction_Temperature_h;/* '<S2>/K_Reduction_Temperature' */
  B_Apps_Sat_Dwn_Racing_Mode_T K_Reduction_P_g;/* '<S2>/K_Reduction_P' */
  B_Max_Regenerative_Torque_Rac_T Power_Limit_g;/* '<S2>/Power_Limit' */
  B_Max_Regenerative_Torque_Rac_T Max_Regenerative_Torque_e;/* '<S2>/Max_Regenerative_Torque' */
  B_Apps_Sat_Dwn_Racing_Mode_T Apps_Sat_Up_p;/* '<S2>/Apps_Sat_Up' */
  B_Apps_Sat_Dwn_Racing_Mode_T Apps_Sat_Dwn_k;/* '<S2>/Apps_Sat_Dwn' */
  B_SKF_Initial_Racing_Mode_T Cte_CKF_o;/* '<S2>/Cte_CKF' */
  B_SKF_Initial_Racing_Mode_T Cte_SKF_d;/* '<S2>/Cte_SKF' */
  B_SKF_Initial_Racing_Mode_T CKF_Initial_p;/* '<S2>/CKF_Initial' */
  B_SKF_Initial_Racing_Mode_T SKF_Initial_g;/* '<S2>/SKF_Initial' */
} B_Racing_Mode_T;
