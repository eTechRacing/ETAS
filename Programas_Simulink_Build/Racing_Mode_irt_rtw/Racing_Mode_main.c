 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Racing_Mode();

/* Function: irt_Start_Racing_Mode ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Racing_Mode **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Racing_Mode */

/* Function: irt_OneStep_Racing_Mode ======================================================
 *
 * Abstract:
...
void irt_OneStep_Racing_Mode()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Racing_Mode */

/* Function: irt_Terminate_Racing_Mode ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Racing_Mode */

/* EOF: Racing_Mode_main.c */
