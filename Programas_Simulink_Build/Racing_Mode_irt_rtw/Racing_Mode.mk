...
# make matlab happy
MODEL                = Racing_Mode
MODULES              = Racing_Mode_data.c Racing_Mode_main.c
MAKEFILE             = Racing_Mode.mk
...
TID01EQ              = 0
NCSTATES             = 0
BUILDARGS            =  MODELLIB=Racing_Modelib.lib MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING RELATIVE_PATH_TO_ANCHOR=.. MAT_FILE=0 IRTWaitForStartMsg=0
MULTITASKING         = 0
EXT_MODE             = 0
