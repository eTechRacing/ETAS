...
SLEXEC_SIMBRIDGE_PUBLISHED_C void slexecSetNumTicksToNextSampleHitForVariableDiscreteRate(
    SimStruct* rootS,
    size_t vdrIdx,
    size_t nTicks);

SLEXEC_SIMBRIDGE_PUBLISHED_C size_t slexecGetNumTicksToNextSampleHitForVariableDiscreteRate(
    SimStruct* rootS,
    size_t vdrIdx);
