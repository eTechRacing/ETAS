...
/* PATCH BEGIN */
#include "Racing_Mode_ETR07_irtmacros.h"
/* PATCH END */
...
#ifndef RTW_HEADER_Racing_Mode_ETR07_h_
#define RTW_HEADER_Racing_Mode_ETR07_h_
#include <math.h>
#include <string.h>
#ifndef Racing_Mode_ETR07_COMMON_INCLUDES_
# define Racing_Mode_ETR07_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "zero_crossing_types.h"
#include "simstruc.h"
#include "fixedpoint.h"
#endif                                 /* Racing_Mode_ETR07_COMMON_INCLUDES_ */

#include "Racing_Mode_ETR07_types.h"
...
#define Racing_Mode_ETR07_rtModel      RT_MODEL_Racing_Mode_ETR07_T

/* Block signals for system '<S2>/SKF_Initial' */
typedef struct {
  real_T Gain;                         /* '<S17>/Gain' */
} B_SKF_Initial_Racing_Mode_ETR_T;
...
typedef struct {
  ...
  B_SKF_Initial_Racing_Mode_ETR_T K_Reduction_Temperature;/* '<S2>/K_Reduction_Temperature' */
  B_SKF_Initial_Racing_Mode_ETR_T K_Reduction_P;/* '<S2>/K_Reduction_P' */
  ...
  B_SKF_Initial_Racing_Mode_ETR_T Apps_Sat_Up;/* '<S2>/Apps_Sat_Up' */
  B_SKF_Initial_Racing_Mode_ETR_T Apps_Sat_Dwn;/* '<S2>/Apps_Sat_Dwn' */
  B_SKF_Initial_Racing_Mode_ETR_T Cte_CKF;/* '<S2>/Cte_CKF' */
  B_SKF_Initial_Racing_Mode_ETR_T Cte_SKF;/* '<S2>/Cte_SKF' */
  B_SKF_Initial_Racing_Mode_ETR_T CKF_Initial;/* '<S2>/CKF_Initial' */
  B_SKF_Initial_Racing_Mode_ETR_T SKF_Initial;/* '<S2>/SKF_Initial' */
} B_Racing_Mode_ETR07_T;
...
} ExtY_Racing_Mode_ETR07_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Racing_Mode_ETR07_B
#define BlockIO                        B_Racing_Mode_ETR07_T
#define rtU                            Racing_Mode_ETR07_U
#define ExternalInputs                 ExtU_Racing_Mode_ETR07_T
#define rtY                            Racing_Mode_ETR07_Y
#define ExternalOutputs                ExtY_Racing_Mode_ETR07_T
#define rtP                            Racing_Mode_ETR07_P
#define Parameters                     P_Racing_Mode_ETR07_T

/* Parameters for system: '<Root>/Workshop Test (01)' */
struct P_WorkshopTest01_Racing_Mode__T_ {
...
struct P_SKF_Initial_Racing_Mode_ETR_T_ {
...
struct P_Racing_Mode_ETR07_T_ {
  ...
  real_T K_Reduction_TemperatureSatura_m;/* Expression: 0
                                          * Referenced by: '<Root>/K_Reduction_Temperature Saturation'
                                          */
  P_WorkshopTest01_Racing_Mode__T Endurance5Driver22;/* '<S5>/Endurance (5). Driver 2 (2)' */
  P_WorkshopTest01_Racing_Mode__T AutoX4Driver22;/* '<S5>/AutoX (4). Driver 2 (2)' */
  P_WorkshopTest01_Racing_Mode__T Skidpad3Driver22;/* '<S5>/Skidpad (3). Driver 2 (2)' */
  P_WorkshopTest01_Racing_Mode__T Acceleration2Driver22;/* '<S5>/Acceleration (2). Driver 2 (2) ' */
  P_WorkshopTest01_Racing_Mode__T Endurance5Driver11;/* '<S4>/Endurance (5). Driver 1 (1)' */
  P_WorkshopTest01_Racing_Mode__T AutoX4Driver11;/* '<S4>/AutoX (4). Driver 1 (1)' */
  P_WorkshopTest01_Racing_Mode__T Skidpad3Driver11;/* '<S4>/Skidpad (3). Driver 1 (1)' */
  P_WorkshopTest01_Racing_Mode__T Acceleration2Driver11;/* '<S4>/Acceleration (2). Driver 1 (1) ' */
  P_SKF_Initial_Racing_Mode_ETR_T K_Reduction_Temperature;/* '<S2>/K_Reduction_Temperature' */
  P_SKF_Initial_Racing_Mode_ETR_T K_Reduction_P;/* '<S2>/K_Reduction_P' */
  ...
  P_SKF_Initial_Racing_Mode_ETR_T Apps_Sat_Up;/* '<S2>/Apps_Sat_Up' */
  P_SKF_Initial_Racing_Mode_ETR_T Apps_Sat_Dwn;/* '<S2>/Apps_Sat_Dwn' */
  P_SKF_Initial_Racing_Mode_ETR_T Cte_CKF;/* '<S2>/Cte_CKF' */
  P_SKF_Initial_Racing_Mode_ETR_T Cte_SKF;/* '<S2>/Cte_SKF' */
  P_SKF_Initial_Racing_Mode_ETR_T CKF_Initial;/* '<S2>/CKF_Initial' */
  P_SKF_Initial_Racing_Mode_ETR_T SKF_Initial;/* '<S2>/SKF_Initial' */
  P_WorkshopTest01_Racing_Mode__T WorkshopTest01;/* '<Root>/Workshop Test (01)' */
};

/* Real-time Model Data Structure */
struct tag_RTM_Racing_Mode_ETR07_T {
  const char_T *path;
 ...
 * External functions *
 *====================*/
extern Racing_Mode_ETR07_rtModel *Racing_Mode_ETR07(void);
...
extern RT_MODEL_Racing_Mode_ETR07_T *const Racing_Mode_ETR07_M;
 ...
 *
 * '<Root>' : 'Racing_Mode_ETR07'
 * '<S1>'   : 'Racing_Mode_ETR07/Compare To Constant'
 * '<S2>'   : 'Racing_Mode_ETR07/Custom Dash (11)'
 * '<S3>'   : 'Racing_Mode_ETR07/Custom Experiment Environment (12)'
 * '<S4>'   : 'Racing_Mode_ETR07/Driver 1 Modes (21,31,41,51)'
 * '<S5>'   : 'Racing_Mode_ETR07/Driver 2 Modes (22,32,42,52)'
 * '<S6>'   : 'Racing_Mode_ETR07/Tuning'
 * '<S7>'   : 'Racing_Mode_ETR07/Workshop Test (01)'
 * '<S8>'   : 'Racing_Mode_ETR07/Custom Dash (11)/Apps_Sat_Dwn'
 * '<S9>'   : 'Racing_Mode_ETR07/Custom Dash (11)/Apps_Sat_Up'
 * '<S10>'  : 'Racing_Mode_ETR07/Custom Dash (11)/CKF_Initial'
 * '<S11>'  : 'Racing_Mode_ETR07/Custom Dash (11)/Cte_CKF'
 * '<S12>'  : 'Racing_Mode_ETR07/Custom Dash (11)/Cte_SKF'
 * '<S13>'  : 'Racing_Mode_ETR07/Custom Dash (11)/K_Reduction_P'
 * '<S14>'  : 'Racing_Mode_ETR07/Custom Dash (11)/K_Reduction_Temperature'
 * '<S15>'  : 'Racing_Mode_ETR07/Custom Dash (11)/Max_Regenerative_Torque'
 * '<S16>'  : 'Racing_Mode_ETR07/Custom Dash (11)/Power_Limit'
 * '<S17>'  : 'Racing_Mode_ETR07/Custom Dash (11)/SKF_Initial'
 * '<S18>'  : 'Racing_Mode_ETR07/Driver 1 Modes (21,31,41,51)/Acceleration (2). Driver 1 (1) '
 * '<S19>'  : 'Racing_Mode_ETR07/Driver 1 Modes (21,31,41,51)/AutoX (4). Driver 1 (1)'
 * '<S20>'  : 'Racing_Mode_ETR07/Driver 1 Modes (21,31,41,51)/Endurance (5). Driver 1 (1)'
 * '<S21>'  : 'Racing_Mode_ETR07/Driver 1 Modes (21,31,41,51)/Skidpad (3). Driver 1 (1)'
 * '<S22>'  : 'Racing_Mode_ETR07/Driver 2 Modes (22,32,42,52)/Acceleration (2). Driver 2 (2) '
 * '<S23>'  : 'Racing_Mode_ETR07/Driver 2 Modes (22,32,42,52)/AutoX (4). Driver 2 (2)'
 * '<S24>'  : 'Racing_Mode_ETR07/Driver 2 Modes (22,32,42,52)/Endurance (5). Driver 2 (2)'
 * '<S25>'  : 'Racing_Mode_ETR07/Driver 2 Modes (22,32,42,52)/Skidpad (3). Driver 2 (2)'
 */
#endif                                 /* RTW_HEADER_Racing_Mode_ETR07_h_ */
