/*
 * File    : Torque_Control_ETR07_irtmacros.h
 *
 * Abstract:
...
#ifndef utAssert
#define utAssert(_exp)                 if(!(_exp)){ asdWriteUserDebug("IRT RTI: ** Simulink assertblock shows assertion failed. The expression was: '" #_exp "' **\n"); rtmSetStopRequestedFlag(Torque_Control_ETR07_M, 1); asdWriteUserDebug("IRT RTI: ** Simulation halted! **\n");}
#endif

/* EOF: Torque_Control_ETR07_irtmacros.h */
