...
/* The file must only be included for the implementation of code for TASK(SWT_CAN1_AP_BMS_Voltages) */

#ifndef OS_TASK_SWT_CAN1_AP_BMS_Voltages
#define OS_TASK_SWT_CAN1_AP_BMS_Voltages
...
#endif /* OS_TASK_SWT_CAN1_AP_BMS_Voltages */
