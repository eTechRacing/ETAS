 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Power_Control();

/* Function: irt_Start_Power_Control ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Power_Control **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Power_Control */

/* Function: irt_OneStep_Power_Control ======================================================
 *
 * Abstract:
 ...
 *
 */
void irt_OneStep_Power_Control()
{
  if (errorFlag) {
    return;
  }
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Power_Control */

/* Function: irt_Terminate_Power_Control ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Power_Control */

/* EOF: Power_Control_main.c */
