 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Disconnections();

/* Function: irt_Start_Disconnections ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Disconnections **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Disconnections */

/* Function: irt_OneStep_Disconnections ======================================================
 *
 * Abstract:
 ...
 *
 */
void irt_OneStep_Disconnections()
{
  if (errorFlag) {
    return;
  }
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Disconnections */

/* Function: irt_Terminate_Disconnections ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Disconnections */

/* EOF: Disconnections_main.c */
