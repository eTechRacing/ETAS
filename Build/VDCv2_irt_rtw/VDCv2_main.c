 ...
 * Visible functions *
 *===================*/
void irt_Terminate_VDCv2();

/* Function: irt_Start_VDCv2 ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model VDCv2 **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
...
void irt_OneStep_VDCv2()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_VDCv2 */

/* Function: irt_Terminate_VDCv2 ====================================================
 *
 * Abstract:
