 ...
 * Visible functions *
 *===================*/
void irt_Terminate_VDC();

/* Function: irt_Start_VDC ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model VDC **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
