...
typedef struct {
  const real_T Saturation;             /* '<S3>/Saturation' */
  const real_T Saturation_c;           /* '<S2>/Saturation' */
} ConstB_SoC_T;

/* External inputs (root inport signals with default storage) */
typedef struct {
  real_T Lowest_Cell_Voltage;          /* '<Root>/Lowest_Cell_Voltage' */
  real_T Highest_Cell_Voltage;         /* '<Root>/Highest_Cell_Voltage' */
...
typedef struct {
  ...
  real_T CSoC_L;                       /* '<Root>/CSoC_L' */
  real_T KFSoC_L;                      /* '<Root>/KFSoC_L' */
  real_T CSoC_H;                       /* '<Root>/CSoC_H' */
  real_T KFSoC_H;                      /* '<Root>/KFSoC_H' */
 ...
 * '<S10>'  : 'SoC/SoC_Lowest/SOC Estimator (Coulomb Counting)/Integrator'
 * '<S11>'  : 'SoC/SoC_Lowest/SOC Estimator (Coulomb Counting)/Integrator/Discrete'
 */
