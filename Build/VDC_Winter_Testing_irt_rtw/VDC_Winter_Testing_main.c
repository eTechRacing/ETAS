/*
 * File    : VDC_Winter_Testing_main.c
 *
 * Abstract:
 ...
 * Visible functions *
 *===================*/
void irt_Terminate_VDC_Winter_Testing();

/* Function: irt_Start_VDC_Winter_Testing ========================================================
 *
 * Abstract:
 ...
 *
 */
void irt_Start_VDC_Winter_Testing()
{
  const char *status;
   ...
   *****************************************/
  if (S != NULL) {
    irt_Terminate_VDC_Winter_Testing();
  }
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model VDC_Winter_Testing **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_VDC_Winter_Testing */

/* Function: irt_OneStep_VDC_Winter_Testing ======================================================
 *
 * Abstract:
 ...
 *
 */
void irt_OneStep_VDC_Winter_Testing()
{
  if (errorFlag) {
    return;
  }
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_VDC_Winter_Testing */

/* Function: irt_Terminate_VDC_Winter_Testing ====================================================
 *
 * Abstract:
...
}                                     /* end irt_Terminate_VDC_Winter_Testing */

/* EOF: VDC_Winter_Testing_main.c */
