 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Sensors();

/* Function: irt_Start_Sensors ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Sensors **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Sensors */

/* Function: irt_OneStep_Sensors ======================================================
 *
 * Abstract:
...
void irt_OneStep_Sensors()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Sensors */

/* Function: irt_Terminate_Sensors ====================================================
 *
 * Abstract:
