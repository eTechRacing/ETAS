 ...
 * Visible functions *
 *===================*/
void irt_Terminate_VDCv2mk2();

/* Function: irt_Start_VDCv2mk2 ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model VDCv2mk2 **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_VDCv2mk2 */

/* Function: irt_OneStep_VDCv2mk2 ======================================================
 *
 * Abstract:
...
void irt_OneStep_VDCv2mk2()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_VDCv2mk2 */

/* Function: irt_Terminate_VDCv2mk2 ====================================================
 *
 * Abstract:
