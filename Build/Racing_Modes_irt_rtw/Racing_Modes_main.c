 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Racing_Modes();

/* Function: irt_Start_Racing_Modes ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Racing_Modes **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Racing_Modes */

/* Function: irt_OneStep_Racing_Modes ======================================================
 *
 * Abstract:
...
void irt_OneStep_Racing_Modes()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Racing_Modes */

/* Function: irt_Terminate_Racing_Modes ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Racing_Modes */

/* EOF: Racing_Modes_main.c */
