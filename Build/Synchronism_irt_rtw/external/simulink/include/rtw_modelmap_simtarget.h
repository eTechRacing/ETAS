...
SLSA_SIM_PUBLISHED_C void slsa_free(void* arg);
SLSA_SIM_PUBLISHED_C void* slsa_malloc(size_t size);
SLSA_SIM_PUBLISHED_C char* rtwCAPI_EncodePath(const char* path);
SLSA_SIM_PUBLISHED_C boolean_T rtwCAPI_HasStates(const rtwCAPI_ModelMappingInfo* mmi);
SLSA_SIM_PUBLISHED_C int_T rtwCAPI_GetNumStateRecords(const rtwCAPI_ModelMappingInfo* mmi);
SLSA_SIM_PUBLISHED_C int_T
rtwCAPI_GetNumStateRecordsForRTWLogging(const rtwCAPI_ModelMappingInfo* mmi);
SLSA_SIM_PUBLISHED_C int_T rtwCAPI_GetNumContStateRecords(const rtwCAPI_ModelMappingInfo* mmi);
SLSA_SIM_PUBLISHED_C void rtwCAPI_FreeFullPaths(rtwCAPI_ModelMappingInfo* mmi);
SLSA_SIM_PUBLISHED_C const char_T* rtwCAPI_UpdateFullPaths(rtwCAPI_ModelMappingInfo* mmi,
                                                           const char_T* path,
                                                           boolean_T isCalledFromTopModel);
SLSA_SIM_PUBLISHED_C char* rtwCAPI_GetFullStateBlockPath(const char* stateBlockPath,
                                                         const char* mmiPath,
                                                         size_t mmiPathLen,
                                                         boolean_T crossingModel);
SLSA_SIM_PUBLISHED_C uint_T rtwCAPI_GetStateWidth(const rtwCAPI_DimensionMap* dimMap,
                                                  const uint_T* dimArray,
                                                  const rtwCAPI_States* states,
                                                  uint_T iState);
SLSA_SIM_PUBLISHED_C const char_T* rtwCAPI_GetStateRecordInfo(
    ...
    int_T* stateIdxList);
SLSA_SIM_PUBLISHED_C int_T rtwCAPI_GetNumSigLogRecords(const rtwCAPI_ModelMappingInfo* mmi);
SLSA_SIM_PUBLISHED_C int_T
rtwCAPI_GetNumSigLogRecordsForRTWLogging(const rtwCAPI_ModelMappingInfo* mmi);
SLSA_SIM_PUBLISHED_C const char_T* rtwCAPI_GetSigLogRecordInfo(const rtwCAPI_ModelMappingInfo* mmi,
                                                               const char_T** sigBlockName,
                                                               const char_T** sigLabel,
                                                               int_T* sigWidth,
                                                               int_T* sigDataType,
                                                               ...
                                                               boolean_T crossingModel,
                                                               boolean_T rtwLogging);
SLSA_SIM_PUBLISHED_C void rtwCAPI_CountSysRan(const rtwCAPI_ModelMappingInfo* mmi, int* count);
SLSA_SIM_PUBLISHED_C void rtwCAPI_FillSysRan(const rtwCAPI_ModelMappingInfo* mmi,
                                             sysRanDType** sysRan,
                                             int* sysTid,
                                             int* fillIdx);
SLSA_SIM_PUBLISHED_C const char_T* rt_FillStateSigInfoFromMMI(RTWLogInfo* li,
                                                              const char_T** errStatus);
SLSA_SIM_PUBLISHED_C void rt_CleanUpForStateLogWithMMI(RTWLogInfo* li);
