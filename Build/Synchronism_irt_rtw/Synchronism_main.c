 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Synchronism();

/* Function: irt_Start_Synchronism ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Synchronism **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Synchronism */

/* Function: irt_OneStep_Synchronism ======================================================
 *
 * Abstract:
...
void irt_OneStep_Synchronism()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Synchronism */

/* Function: irt_Terminate_Synchronism ====================================================
 *
 * Abstract:
...
}                                      /* end irt_Terminate_Synchronism */

/* EOF: Synchronism_main.c */
