 ...
 * Visible functions *
 *===================*/
void irt_Terminate_Ellipse();

/* Function: irt_Start_Ellipse ========================================================
 *
 * Abstract:
...
# endif
  ...
  asdWriteUserDebug("IRT RTI: ** starting model Ellipse **\n");
  MdlStart();
  if (rtmGetErrorStatus(S) != NULL) {
    GBLbuf.stopExecutionFlag = 1;
  }
   ...
   * application.                                                          *
   *************************************************************************/
}                                      /* end irt_Start_Ellipse */

/* Function: irt_OneStep_Ellipse ======================================================
 *
 * Abstract:
...
void irt_OneStep_Ellipse()
{
  ...
  checkForErrors(S);
}                                      /* end irt_OneStep_Ellipse */

/* Function: irt_Terminate_Ellipse ====================================================
 *
 * Abstract:
