    ...
    for j = 1:length(VS);
        ...
        for k=1:10     
           ...
           %{ 
            ...
            gammaFL(i,j)=abs((gammaF0+0.36842*rollangle(i,j))*pi/180); %rollangle i camber en rad 
            gammaFR(i,j)=abs((gammaF0-0.36842*rollangle(i,j))*pi/180); %rollangle i camber en rad
            gammaRL(i,j)=abs((gammaR0+0.36842*rollangle(i,j))*pi/180); %rollangle i camber en rad 
            gammaRR(i,j)=abs((gammaR0-0.36842*rollangle(i,j))*pi/180); %rollangle i camber en rad 
           %}
