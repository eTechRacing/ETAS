...
car.a = 0.83;%Distancia ruedas del a cg
car.b = car.l-car.a;%Distancia ruedas tras a cg
car.Tf = 1.25;%Trackwith front
car.Tr = 1.15;%Trackwith rear
car.weight = 325; %Pes
car.Zrf=0.06791; %Roll center front
car.Zrr=0.07483; %Roll center rear
car.H=0.25;
car.Kf= 276.77; %roll stiffnes front
car.Kr= 249.6; %roll stiffnes rear
car.h= 0.3; 
...
gammaF0=-1.2; %Front Camber deg
gammaR0=-1.2; %Rear Camber deg
